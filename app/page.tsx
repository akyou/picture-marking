...
export default function Page() {
  ...
  const draggingRef = useRef<{ id: string; start: Point; origin: Point; points?: Point[]; ids?: string[]; origins?: Record<string, Point>; strokePoints?: Record<string, Point[]> } | null>(null)
