...
function perspectiveRingPath(width: number, height: number, color: string, opacity: number, ringHeight = 37, ringPitch = 45) {
  ...
  const topY = cy - d
  const bottomY = cy + d
  const top = `M ${left} ${topY} A ${R} ${ry} 0 0 1 ${right} ${topY} A ${innerR} ${innerRy} 0 0 0 ${left + (R - innerR)} ${cy} A ${innerR} ${innerRy} 0 0 0 ${left} ${topY} Z`
  const bottom = `M ${left} ${bottomY} A ${R} ${ry} 0 0 0 ${right} ${bottomY} A ${innerR} ${innerRy} 0 0 1 ${left + (R - innerR)} ${cy} A ${innerR} ${innerRy} 0 0 1 ${left} ${bottomY} Z`
  const side = `M ${left} ${topY} L ${left} ${bottomY} A ${R} ${ry} 0 0 0 ${right} ${bottomY} L ${right} ${topY} A ${R} ${ry} 0 0 1 ${left} ${topY} Z`
  return { top, bottom, side, color, opacity }
}
