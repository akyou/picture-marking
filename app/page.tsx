...
type Item =
  ...
  | { id: string; kind: 'stamp'; stamp: 'arrow' | 'circle' | 'check' | 'curve'; x: number; y: number; width: number; height: number; color: string; opacity: number; rotation: number; strokeWidth: number; arrowCurve?: number; arrowHeadSize?: number; arrowHeadAngle?: number; arrowTipInset?: number; arrowTailLength?: number; circleStyle?: 'plain' | 'overlay' | 'ring3d'; circleTilt?: number; ringThickness?: number; ringGap?: number; locked?: boolean; hidden?: boolean }
